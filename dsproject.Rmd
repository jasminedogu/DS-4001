...
Overall, plotly serves as a great data visualization tool for data scientists to use but can easily be replaced with basic functions of the ggplot2 package.
